...
public class SimplepdlPackageImpl extends EPackageImpl implements SimplepdlPackage {
	 ...
	 * @generated
	 */
	private EClass ressourceNeedEClass = null;
	 ...
	 */
	@Override
	public EReference getWorkDefinition_LinksToNeeds() {
	 ...
	 */
	@Override
	public EAttribute getRessource_Amount() {
	 ...
	 */
	@Override
	public EClass getRessourceNeed() {
		return ressourceNeedEClass;
	}
	 ...
	 */
	@Override
	public EAttribute getRessourceNeed_Need() {
		return (EAttribute)ressourceNeedEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EReference getRessourceNeed_LinkToRessource() {
		return (EReference)ressourceNeedEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 */
	@Override
	public EReference getRessourceNeed_LinkToWorkDefinition() {
		return (EReference)ressourceNeedEClass.getEStructuralFeatures().get(2);
	}
	...
	public void createPackageContents() {
		...
		createEReference(workDefinitionEClass, WORK_DEFINITION__LINKS_TO_NEEDS);
		...
		createEAttribute(ressourceEClass, RESSOURCE__AMOUNT);

		ressourceNeedEClass = createEClass(RESSOURCE_NEED);
		createEAttribute(ressourceNeedEClass, RESSOURCE_NEED__NEED);
		createEReference(ressourceNeedEClass, RESSOURCE_NEED__LINK_TO_RESSOURCE);
		createEReference(ressourceNeedEClass, RESSOURCE_NEED__LINK_TO_WORK_DEFINITION);
	...
	public void initializePackageContents() {
		...
		initEReference(getWorkDefinition_LinksToNeeds(), this.getRessourceNeed(), this.getRessourceNeed_LinkToWorkDefinition(), "linksToNeeds", null, 0, -1, WorkDefinition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getRessource_Amount(), ecorePackage.getEInt(), "amount", null, 1, 1, Ressource.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(ressourceNeedEClass, RessourceNeed.class, "RessourceNeed", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getRessourceNeed_Need(), ecorePackage.getEInt(), "need", null, 1, 1, RessourceNeed.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getRessourceNeed_LinkToRessource(), this.getRessource(), null, "linkToRessource", null, 1, 1, RessourceNeed.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getRessourceNeed_LinkToWorkDefinition(), this.getWorkDefinition(), this.getWorkDefinition_LinksToNeeds(), "linkToWorkDefinition", null, 1, 1, RessourceNeed.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
