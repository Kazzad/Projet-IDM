...
public class SimplepdlFactoryImpl extends EFactoryImpl implements SimplepdlFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case SimplepdlPackage.RESSOURCE_NEED: return createRessourceNeed();
			default:
	 ...
	 */
	@Override
	public RessourceNeed createRessourceNeed() {
		RessourceNeedImpl ressourceNeed = new RessourceNeedImpl();
