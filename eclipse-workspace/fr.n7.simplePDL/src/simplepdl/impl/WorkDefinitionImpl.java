 ...
 *   <li>{@link simplepdl.impl.WorkDefinitionImpl#getLinksToNeeds <em>Links To Needs</em>}</li>
 * </ul>
 *
 * @generated
 */
public class WorkDefinitionImpl extends ProcessElementImpl implements WorkDefinition {
	...
	/**
	 * The cached value of the '{@link #getLinksToNeeds() <em>Links To Needs</em>}' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getLinksToNeeds()
	 * @generated
	 * @ordered
	 */
	protected EList<RessourceNeed> linksToNeeds;
	 ...
	 */
	@Override
	public EList<RessourceNeed> getLinksToNeeds() {
		if (linksToNeeds == null) {
			linksToNeeds = new EObjectContainmentWithInverseEList<RessourceNeed>(RessourceNeed.class, this, SimplepdlPackage.WORK_DEFINITION__LINKS_TO_NEEDS, SimplepdlPackage.RESSOURCE_NEED__LINK_TO_WORK_DEFINITION);
		}
		return linksToNeeds;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case SimplepdlPackage.WORK_DEFINITION__LINKS_TO_NEEDS:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getLinksToNeeds()).basicAdd(otherEnd, msgs);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case SimplepdlPackage.WORK_DEFINITION__LINKS_TO_NEEDS:
				return ((InternalEList<?>)getLinksToNeeds()).basicRemove(otherEnd, msgs);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case SimplepdlPackage.WORK_DEFINITION__LINKS_TO_SUCCESSORS:
				...
				return;
			case SimplepdlPackage.WORK_DEFINITION__LINKS_TO_NEEDS:
				getLinksToNeeds().clear();
				getLinksToNeeds().addAll((Collection<? extends RessourceNeed>)newValue);
				return;
		}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case SimplepdlPackage.WORK_DEFINITION__LINKS_TO_NEEDS:
				return linksToNeeds != null && !linksToNeeds.isEmpty();
		}
