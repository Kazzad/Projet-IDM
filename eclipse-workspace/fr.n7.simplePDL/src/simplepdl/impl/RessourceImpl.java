 ...
 *   <li>{@link simplepdl.impl.RessourceImpl#getAmount <em>Amount</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RessourceImpl extends ProcessElementImpl implements Ressource {
	...
	public void setAmount(int newAmount) {
		...
		amount = newAmount;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SimplepdlPackage.RESSOURCE__AMOUNT, oldAmount, amount));
	}
