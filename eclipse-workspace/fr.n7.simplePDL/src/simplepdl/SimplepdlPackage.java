...
public interface SimplepdlPackage extends EPackage {
	...
	/**
	 * The feature id for the '<em><b>Links To Needs</b></em>' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int WORK_DEFINITION__LINKS_TO_NEEDS = PROCESS_ELEMENT_FEATURE_COUNT + 3;
	 ...
	 * @ordered
	 */
	int RESSOURCE__AMOUNT = PROCESS_ELEMENT_FEATURE_COUNT + 1;
	...
	/**
	 * The meta object id for the '{@link simplepdl.impl.RessourceNeedImpl <em>Ressource Need</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see simplepdl.impl.RessourceNeedImpl
	 * @see simplepdl.impl.SimplepdlPackageImpl#getRessourceNeed()
	 * @generated
	 */
	int RESSOURCE_NEED = 6;
	 ...
	 * @ordered
	 */
	int RESSOURCE_NEED__NEED = 0;

	/**
	 * The feature id for the '<em><b>Link To Ressource</b></em>' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int RESSOURCE_NEED__LINK_TO_RESSOURCE = 1;

	/**
	 * The feature id for the '<em><b>Link To Work Definition</b></em>' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int RESSOURCE_NEED__LINK_TO_WORK_DEFINITION = 2;

	/**
	 * The number of structural features of the '<em>Ressource Need</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int RESSOURCE_NEED_FEATURE_COUNT = 3;

	/**
	 * The number of operations of the '<em>Ressource Need</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int RESSOURCE_NEED_OPERATION_COUNT = 0;
	...
	/**
	 * Returns the meta object for the containment reference list '{@link simplepdl.WorkDefinition#getLinksToNeeds <em>Links To Needs</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Links To Needs</em>'.
	 * @see simplepdl.WorkDefinition#getLinksToNeeds()
	 * @see #getWorkDefinition()
	 * @generated
	 */
	EReference getWorkDefinition_LinksToNeeds();
	...
	/**
	 * Returns the meta object for the attribute '{@link simplepdl.Ressource#getAmount <em>Amount</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Amount</em>'.
	 * @see simplepdl.Ressource#getAmount()
	 * @see #getRessource()
	 * @generated
	 */
	EAttribute getRessource_Amount();

	/**
	 * Returns the meta object for class '{@link simplepdl.RessourceNeed <em>Ressource Need</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Ressource Need</em>'.
	 * @see simplepdl.RessourceNeed
	 * @generated
	 */
	EClass getRessourceNeed();

	/**
	 * Returns the meta object for the attribute '{@link simplepdl.RessourceNeed#getNeed <em>Need</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Need</em>'.
	 * @see simplepdl.RessourceNeed#getNeed()
	 * @see #getRessourceNeed()
	 * @generated
	 */
	EAttribute getRessourceNeed_Need();

	/**
	 * Returns the meta object for the reference '{@link simplepdl.RessourceNeed#getLinkToRessource <em>Link To Ressource</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Link To Ressource</em>'.
	 * @see simplepdl.RessourceNeed#getLinkToRessource()
	 * @see #getRessourceNeed()
	 * @generated
	 */
	EReference getRessourceNeed_LinkToRessource();

	/**
	 * Returns the meta object for the container reference '{@link simplepdl.RessourceNeed#getLinkToWorkDefinition <em>Link To Work Definition</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the container reference '<em>Link To Work Definition</em>'.
	 * @see simplepdl.RessourceNeed#getLinkToWorkDefinition()
	 * @see #getRessourceNeed()
	 * @generated
	 */
	EReference getRessourceNeed_LinkToWorkDefinition();
	...
	interface Literals {
		...
		/**
		 * The meta object literal for the '<em><b>Links To Needs</b></em>' containment reference list feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EReference WORK_DEFINITION__LINKS_TO_NEEDS = eINSTANCE.getWorkDefinition_LinksToNeeds();
		 ...
		 * @generated
		 */
		EAttribute RESSOURCE__AMOUNT = eINSTANCE.getRessource_Amount();

		/**
		 * The meta object literal for the '{@link simplepdl.impl.RessourceNeedImpl <em>Ressource Need</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see simplepdl.impl.RessourceNeedImpl
		 * @see simplepdl.impl.SimplepdlPackageImpl#getRessourceNeed()
		 * @generated
		 */
		EClass RESSOURCE_NEED = eINSTANCE.getRessourceNeed();
		 ...
		 * @generated
		 */
		EAttribute RESSOURCE_NEED__NEED = eINSTANCE.getRessourceNeed_Need();

		/**
		 * The meta object literal for the '<em><b>Link To Ressource</b></em>' reference feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EReference RESSOURCE_NEED__LINK_TO_RESSOURCE = eINSTANCE.getRessourceNeed_LinkToRessource();

		/**
		 * The meta object literal for the '<em><b>Link To Work Definition</b></em>' container reference feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EReference RESSOURCE_NEED__LINK_TO_WORK_DEFINITION = eINSTANCE.getRessourceNeed_LinkToWorkDefinition();
