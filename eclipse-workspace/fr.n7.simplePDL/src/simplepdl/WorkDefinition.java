 ...
 *   <li>{@link simplepdl.WorkDefinition#getLinksToNeeds <em>Links To Needs</em>}</li>
 * </ul>
 *
...
public interface WorkDefinition extends ProcessElement {
	...
	/**
	 * Returns the value of the '<em><b>Links To Needs</b></em>' containment reference list.
	 * The list contents are of type {@link simplepdl.RessourceNeed}.
	 * It is bidirectional and its opposite is '{@link simplepdl.RessourceNeed#getLinkToWorkDefinition <em>Link To Work Definition</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Links To Needs</em>' containment reference list.
	 * @see simplepdl.SimplepdlPackage#getWorkDefinition_LinksToNeeds()
	 * @see simplepdl.RessourceNeed#getLinkToWorkDefinition
	 * @model opposite="linkToWorkDefinition" containment="true"
	 * @generated
	 */
	EList<RessourceNeed> getLinksToNeeds();
