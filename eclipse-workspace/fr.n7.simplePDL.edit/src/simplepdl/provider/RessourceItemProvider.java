...
public class RessourceItemProvider extends ProcessElementItemProvider {
	...
	protected void addAmountPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Ressource_amount_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Ressource_amount_feature", "_UI_Ressource_type"),
				 SimplepdlPackage.Literals.RESSOURCE__AMOUNT,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Ressource.class)) {
			...
			case SimplepdlPackage.RESSOURCE__AMOUNT:
