...
public class SimplepdlItemProviderAdapterFactory extends SimplepdlAdapterFactory implements ComposeableAdapterFactory, IChangeNotifier, IDisposable {
	...
	/**
	 * This keeps track of the one adapter used for all {@link simplepdl.RessourceNeed} instances.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected RessourceNeedItemProvider ressourceNeedItemProvider;

	/**
	 * This creates an adapter for a {@link simplepdl.RessourceNeed}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Adapter createRessourceNeedAdapter() {
		if (ressourceNeedItemProvider == null) {
			ressourceNeedItemProvider = new RessourceNeedItemProvider(this);
		}

		return ressourceNeedItemProvider;
	}
	...
	public void dispose() {
		...
		if (ressourceNeedItemProvider != null) ressourceNeedItemProvider.dispose();
	}
