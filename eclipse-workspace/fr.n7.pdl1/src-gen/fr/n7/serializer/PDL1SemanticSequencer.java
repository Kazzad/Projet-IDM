...
public class PDL1SemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == PDL1Package.eINSTANCE)
			...
			case PDL1Package.RESSOURCE:
				...
				return; 
			case PDL1Package.RESSOURCE_NEED:
				sequence_RessourceNeed(context, (RessourceNeed) semanticObject); 
				return; 
	 ...
	 * <pre>
	 * Contexts:
	 *     RessourceNeed returns RessourceNeed
	 *
	 * Constraint:
	 *     (need=INT linkToRessource=[Ressource|ID])
	 * </pre>
	 */
	protected void sequence_RessourceNeed(ISerializationContext context, RessourceNeed semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, PDL1Package.Literals.RESSOURCE_NEED__NEED) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, PDL1Package.Literals.RESSOURCE_NEED__NEED));
			if (transientValues.isValueTransient(semanticObject, PDL1Package.Literals.RESSOURCE_NEED__LINK_TO_RESSOURCE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, PDL1Package.Literals.RESSOURCE_NEED__LINK_TO_RESSOURCE));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getRessourceNeedAccess().getNeedINTTerminalRuleCall_1_0(), semanticObject.getNeed());
		feeder.accept(grammarAccess.getRessourceNeedAccess().getLinkToRessourceRessourceIDTerminalRuleCall_3_0_1(), semanticObject.eGet(PDL1Package.Literals.RESSOURCE_NEED__LINK_TO_RESSOURCE, false));
		feeder.finish();
	}
	...
	protected void sequence_Ressource(ISerializationContext context, Ressource semanticObject) {
		if (errorAcceptor != null) {
			...
			if (transientValues.isValueTransient(semanticObject, PDL1Package.Literals.RESSOURCE__AMOUNT) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, PDL1Package.Literals.RESSOURCE__AMOUNT));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getRessourceAccess().getNameIDTerminalRuleCall_1_0(), semanticObject.getName());
		feeder.accept(grammarAccess.getRessourceAccess().getAmountINTTerminalRuleCall_2_0(), semanticObject.getAmount());
		feeder.finish();
	}
	 ...
	 *
	 * Constraint:
	 *     (name=ID linksToNeeds+=RessourceNeed*)
	 * </pre>
	 */
