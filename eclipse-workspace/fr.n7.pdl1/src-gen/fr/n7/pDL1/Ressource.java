 ...
 *   <li>{@link fr.n7.pDL1.Ressource#getAmount <em>Amount</em>}</li>
 * </ul>
 *
...
public interface Ressource extends ProcessElement
{
   ...
   * @see #setAmount(int)
   * @see fr.n7.pDL1.PDL1Package#getRessource_Amount()
   * @model
   * @generated
   */
  int getAmount();
  ...
  /**
   * Sets the value of the '{@link fr.n7.pDL1.Ressource#getAmount <em>Amount</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
