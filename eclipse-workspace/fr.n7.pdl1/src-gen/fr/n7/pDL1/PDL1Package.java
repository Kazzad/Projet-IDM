...
public interface PDL1Package extends EPackage
{
   ...
   * @ordered
   */
  int WORK_DEFINITION__LINKS_TO_NEEDS = PROCESS_ELEMENT_FEATURE_COUNT + 1;
  ...
  /**
   * The meta object id for the '{@link fr.n7.pDL1.impl.RessourceNeedImpl <em>Ressource Need</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see fr.n7.pDL1.impl.RessourceNeedImpl
   * @see fr.n7.pDL1.impl.PDL1PackageImpl#getRessourceNeed()
   * @generated
   */
   ...
   * @ordered
   */
  int RESSOURCE_NEED_FEATURE_COUNT = 2;
  ...
  /**
   * Returns the meta object for the containment reference list '{@link fr.n7.pDL1.WorkDefinition#getLinksToNeeds <em>Links To Needs</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference list '<em>Links To Needs</em>'.
   * @see fr.n7.pDL1.WorkDefinition#getLinksToNeeds()
   * @see #getWorkDefinition()
   * @generated
   */
  ...
  /**
   * Returns the meta object for the attribute '{@link fr.n7.pDL1.Ressource#getAmount <em>Amount</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Amount</em>'.
   * @see fr.n7.pDL1.Ressource#getAmount()
   * @see #getRessource()
   * @generated
   */
  ...
  /**
   * Returns the meta object for class '{@link fr.n7.pDL1.RessourceNeed <em>Ressource Need</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for class '<em>Ressource Need</em>'.
   * @see fr.n7.pDL1.RessourceNeed
   * @generated
   */
  EClass getRessourceNeed();

  /**
   * Returns the meta object for the attribute '{@link fr.n7.pDL1.RessourceNeed#getNeed <em>Need</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Need</em>'.
   * @see fr.n7.pDL1.RessourceNeed#getNeed()
  ...
  /**
   * Returns the meta object for the reference '{@link fr.n7.pDL1.RessourceNeed#getLinkToRessource <em>Link To Ressource</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the reference '<em>Link To Ressource</em>'.
   * @see fr.n7.pDL1.RessourceNeed#getLinkToRessource()
   * @see #getRessourceNeed()
   * @generated
   */
  ...
  interface Literals
  {
    ...
    /**
     * The meta object literal for the '{@link fr.n7.pDL1.impl.RessourceNeedImpl <em>Ressource Need</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see fr.n7.pDL1.impl.RessourceNeedImpl
     * @see fr.n7.pDL1.impl.PDL1PackageImpl#getRessourceNeed()
