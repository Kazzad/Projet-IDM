...
public class PDL1PackageImpl extends EPackageImpl implements PDL1Package
{
  ...
  public void initializePackageContents()
  {
    ...
    initEReference(getWorkDefinition_LinksToNeeds(), this.getRessourceNeed(), null, "linksToNeeds", null, 0, -1, WorkDefinition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEAttribute(getRessource_Amount(), ecorePackage.getEInt(), "amount", null, 0, 1, Ressource.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(ressourceNeedEClass, RessourceNeed.class, "RessourceNeed", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getRessourceNeed_Need(), ecorePackage.getEInt(), "need", null, 0, 1, RessourceNeed.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getRessourceNeed_LinkToRessource(), this.getRessource(), null, "linkToRessource", null, 0, 1, RessourceNeed.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
