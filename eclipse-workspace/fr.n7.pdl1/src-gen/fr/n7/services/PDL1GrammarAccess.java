...
public class PDL1GrammarAccess extends AbstractElementFinder.AbstractGrammarElementFinder {
	...
	public class WorkDefinitionElements extends AbstractParserRuleElementFinder {
		...
		private final Assignment cLinksToNeedsAssignment_3 = (Assignment)cGroup.eContents().get(3);
		private final RuleCall cLinksToNeedsRessourceNeedParserRuleCall_3_0 = (RuleCall)cLinksToNeedsAssignment_3.eContents().get(0);
		private final Keyword cRightSquareBracketKeyword_4 = (Keyword)cGroup.eContents().get(4);
		
		//WorkDefinition :
		//    'wd' name=ID '['
		//        linksToNeeds+=RessourceNeed*
		//    ']';
		@Override public ParserRule getRule() { return rule; }
		...
		//linksToNeeds+=RessourceNeed*
		public Assignment getLinksToNeedsAssignment_3() { return cLinksToNeedsAssignment_3; }
		
		//RessourceNeed
		public RuleCall getLinksToNeedsRessourceNeedParserRuleCall_3_0() { return cLinksToNeedsRessourceNeedParserRuleCall_3_0; }
	...
	public class RessourceNeedElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "fr.n7.PDL1.RessourceNeed");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Keyword cRessourceNeedKeyword_0 = (Keyword)cGroup.eContents().get(0);
		private final Assignment cNeedAssignment_1 = (Assignment)cGroup.eContents().get(1);
		private final RuleCall cNeedINTTerminalRuleCall_1_0 = (RuleCall)cNeedAssignment_1.eContents().get(0);
		private final Keyword cFromKeyword_2 = (Keyword)cGroup.eContents().get(2);
		private final Assignment cLinkToRessourceAssignment_3 = (Assignment)cGroup.eContents().get(3);
		private final CrossReference cLinkToRessourceRessourceCrossReference_3_0 = (CrossReference)cLinkToRessourceAssignment_3.eContents().get(0);
		private final RuleCall cLinkToRessourceRessourceIDTerminalRuleCall_3_0_1 = (RuleCall)cLinkToRessourceRessourceCrossReference_3_0.eContents().get(1);
		
		//RessourceNeed :
		//    'ressourceNeed' need=INT
		//        'from' linkToRessource=[Ressource];
		@Override public ParserRule getRule() { return rule; }
		...
		//'ressourceNeed'
		public Keyword getRessourceNeedKeyword_0() { return cRessourceNeedKeyword_0; }
		
		//need=INT
		public Assignment getNeedAssignment_1() { return cNeedAssignment_1; }
		
		//INT
		public RuleCall getNeedINTTerminalRuleCall_1_0() { return cNeedINTTerminalRuleCall_1_0; }
		
		//'from'
		public Keyword getFromKeyword_2() { return cFromKeyword_2; }
		
		//linkToRessource=[Ressource]
		public Assignment getLinkToRessourceAssignment_3() { return cLinkToRessourceAssignment_3; }
		
		//[Ressource]
		public CrossReference getLinkToRessourceRessourceCrossReference_3_0() { return cLinkToRessourceRessourceCrossReference_3_0; }
		
		//ID
		public RuleCall getLinkToRessourceRessourceIDTerminalRuleCall_3_0_1() { return cLinkToRessourceRessourceIDTerminalRuleCall_3_0_1; }
	}
	...
	private final RessourceNeedElements pRessourceNeed;
	...
	public PDL1GrammarAccess(GrammarProvider grammarProvider,
		...
		this.pRessourceNeed = new RessourceNeedElements();
	...
	//    'ressourceNeed' need=INT
	//        'from' linkToRessource=[Ressource];
	public RessourceNeedElements getRessourceNeedAccess() {
		return pRessourceNeed;
	}
	
	public ParserRule getRessourceNeedRule() {
		return getRessourceNeedAccess().getRule();
	}
