...
entryRuleRessourceNeed returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getRessourceNeedRule()); }
	iv_ruleRessourceNeed=ruleRessourceNeed
	{ $current=$iv_ruleRessourceNeed.current; }
	EOF;

// Rule RessourceNeed
ruleRessourceNeed returns [EObject current=null]
@init {
	enterRule();
}
@after {
