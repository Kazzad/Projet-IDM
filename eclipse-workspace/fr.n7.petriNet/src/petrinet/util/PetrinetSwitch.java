	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case PetrinetPackage.PLACE: {
				...
				if (result == null) result = caseCaseElement(place);
				if (result == null) result = caseNetworkElement(place);
			...
			case PetrinetPackage.TRANSITION: {
				...
				if (result == null) result = caseCaseElement(transition);
				if (result == null) result = caseNetworkElement(transition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PetrinetPackage.ARC: {
				...
				if (result == null) result = caseNetworkElement(arc);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
