 ...
 *   <li>{@link petrinet.impl.NetworkImpl#getNetworkElements <em>Network Elements</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NetworkImpl extends MinimalEObjectImpl.Container implements Network {
	 ...
	 * @ordered
	 */
	protected EList<NetworkElement> networkElements;
	 ...
	 */
	@Override
	public EList<NetworkElement> getNetworkElements() {
		if (networkElements == null) {
			networkElements = new EObjectContainmentEList<NetworkElement>(NetworkElement.class, this, PetrinetPackage.NETWORK__NETWORK_ELEMENTS);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case PetrinetPackage.NETWORK__NETWORK_ELEMENTS:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case PetrinetPackage.NETWORK__NETWORK_ELEMENTS:
				...
				getNetworkElements().addAll((Collection<? extends NetworkElement>)newValue);
				return;
		}
