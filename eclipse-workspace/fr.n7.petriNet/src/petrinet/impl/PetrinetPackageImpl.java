...
public class PetrinetPackageImpl extends EPackageImpl implements PetrinetPackage {
	 ...
	 */
	@Override
	public EReference getArc_LinkToPrevCase() {
	 ...
	 */
	@Override
	public EReference getArc_LinkToNextCase() {
	 ...
	 */
	@Override
	public EAttribute getCaseElement_Name() {
		return (EAttribute)caseElementEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EReference getCaseElement_LinksToPrevArcs() {
	 ...
	 */
	@Override
	public EReference getCaseElement_LinksToNextArcs() {
		return (EReference)caseElementEClass.getEStructuralFeatures().get(2);
	}
	...
	public void createPackageContents() {
		...
		createEReference(arcEClass, ARC__LINK_TO_PREV_CASE);
		createEReference(arcEClass, ARC__LINK_TO_NEXT_CASE);
		...
		createEAttribute(caseElementEClass, CASE_ELEMENT__NAME);
		createEReference(caseElementEClass, CASE_ELEMENT__LINKS_TO_PREV_ARCS);
		createEReference(caseElementEClass, CASE_ELEMENT__LINKS_TO_NEXT_ARCS);
	}
	...
	public void initializePackageContents() {
		...
		placeEClass.getESuperTypes().add(this.getCaseElement());
		transitionEClass.getESuperTypes().add(this.getCaseElement());
		arcEClass.getESuperTypes().add(this.getNetworkElement());
		caseElementEClass.getESuperTypes().add(this.getNetworkElement());
		...
		initEAttribute(getArc_ReadOnly(), ecorePackage.getEBoolean(), "readOnly", null, 1, 1, Arc.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getArc_LinkToPrevCase(), this.getCaseElement(), this.getCaseElement_LinksToNextArcs(), "linkToPrevCase", null, 1, 1, Arc.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getArc_LinkToNextCase(), this.getCaseElement(), this.getCaseElement_LinksToPrevArcs(), "linkToNextCase", null, 0, 1, Arc.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getNetwork_NetworkElements(), this.getNetworkElement(), null, "networkElements", null, 0, -1, Network.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getCaseElement_Name(), ecorePackage.getEString(), "name", null, 0, 1, CaseElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getCaseElement_LinksToPrevArcs(), this.getArc(), this.getArc_LinkToNextCase(), "linksToPrevArcs", null, 0, -1, CaseElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
